...
const newsData = [
    {
        id: 1,
        title: "Inauguración de campo deportivo con grass sintético en la I.E.S. José Carlos Mariátegui",
        excerpt: "La Municipalidad Distrital de Copani entregó oficialmente un moderno campo deportivo con grass sintético y graderías a la I.E.S. José Carlos Mariátegui.",
        content: `
        <p>El pasado <strong>23 de mayo de 2023</strong> se llevó a cabo la <strong>inauguración oficial del campo deportivo de fulbito con grass sintético y graderías</strong> en la <strong>Institución Educativa Secundaria José Carlos Mariátegui</strong>, ubicada en el distrito de Copani, provincia de Yunguyo, departamento de Puno.</p>
        
        <p>La obra fue entregada el <strong>22 de mayo de 2023</strong> por la <strong>Municipalidad Distrital de Copani</strong>, en el marco de la gestión 2023-2026 liderada por el alcalde <strong>José Barreto Villanueva</strong> y su consejo municipal, a través de la Subgerencia de Infraestructura.</p>

        <p>Este proyecto tan esperado contribuirá de manera significativa al <strong>desarrollo físico y al bienestar estudiantil</strong> mediante la promoción del deporte, fortaleciendo así una educación integral en nuestra comunidad.</p>

        <p>¡Seguimos avanzando por el bienestar de nuestros queridos estudiantes del distrito de Copani!</p>
    `,
        image: "assets/img/news/img1.jpg",
        date: "2023-05-23",
        category: "Infraestructura",
        tags: ["infraestructura", "deporte", "copani", "grass sintético", "educación"],
        featured: false,
        likes: 0,
        views: 0
    },
    {
        id: 2,
        title: "IE José Carlos Mariátegui obtiene segundo lugar en Futsal Damas - Etapa Regional",
        excerpt: "Nuestra institución logró el segundo lugar en la categoría B de futsal damas en la etapa regional de los Juegos Escolares Deportivos y Paradeportivos 2025.",
        content: `
        <p>El pasado <strong>22 de agosto de 2025</strong>, nuestras talentosas estudiantes representaron con orgullo a la <strong>IE José Carlos Mariátegui</strong> - UGEL Yunguyo en la etapa regional de los <strong>Juegos Escolares Deportivos y Paradeportivos 2025</strong>, organizada por la <strong>Dirección Regional de Educación Puno (DRE PUNO)</strong>.</p>
        <p>El equipo de futsal damas categoría B destacó por su excelente desempeño, obteniendo el <strong>segundo lugar</strong> en una competencia reñida y emocionante, demostrando disciplina, trabajo en equipo y compromiso.</p>
        <p>Este logro refleja el esfuerzo de las estudiantes, el apoyo de los docentes y la comunidad educativa que impulsa el desarrollo del deporte escolar en nuestra región.</p>
    `,
        image: "assets/img/news/img2.jpg",
        date: "2025-08-22",
        category: "Deportes",
        tags: ["futsal", "damas", "Juegos Escolares", "DRE Puno", "región", "deportes"],
        featured: false,
        likes: 0,
        views: 0
    },
