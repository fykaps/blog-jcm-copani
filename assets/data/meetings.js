...
const meetingsData = [
    {
        ...
        startTime: "10:00",
        endTime: "14:00",
        title: "Reunión extraordinaria de padres y madres de familia",
        description: "La Dirección en coordinación con la APAFA de la IES 'José Carlos Mariátegui' de Copani convoca a los padres y/o madres de familia a una reunión extraordinaria programada para el jueves 27 de marzo de 2025 en la Sala de Usos Múltiples, a partir de las 10:00 hasta las 14:00 horas.",
        agenda: [
            "Informes generales",
            "Problemática de violencia entre estudiantes",
            "Otros"
        ],
        participants: ["Padres y madres de familia", "Dirección", "APAFA", "Equipo de convivencia escolar"],
        location: "Sala de Usos Múltiples (SUM)",
        category: "Padres de familia",
        organizer: "Dirección del IES José Carlos Mariátegui y APAFA",
        required: true,
        minAttendance: 1,
        status: "scheduled",
        materials: ["Informe de convivencia", "Acta de reunión"],
        recording: false,
    ...
    },
    {
        ...
        startTime: "09:30",
        endTime: "13:00",
        title: "Reunión ordinaria de padres de familia - Dirección y APAFA",
        description: "La Dirección en coordinación con la APAFA de la IES 'José Carlos Mariátegui' de Copani convoca a los padres de familia a participar en una reunión ordinaria programada para el lunes 12 de mayo de 2025, en la Sala de Usos Múltiples a partir de las 09:30 hasta las 13:00.",
        agenda: [
            "Informes del Director",
            "Organización de BAPE",
            "Aprobación de Normas de Convivencia",
            "Informe de recursos propios",
            "Mantenimiento del local escolar",
            "Agenda escolar"
        ],
        participants: ["Padres de familia", "Dirección", "APAFA"],
        location: "Sala de Usos Múltiples (SUM)",
        category: "Padres de familia",
        organizer: "Dirección del IES José Carlos Mariátegui y APAFA",
        required: true,
        minAttendance: 1,
        status: "scheduled",
        materials: ["Normas de convivencia", "Informe de gestión", "Plan de mantenimiento", "Agenda escolar impresa"],
        recording: false,
        followUpRequired: true
    },
    {
        ...
        startTime: "09:30",
        endTime: "11:00",
        title: "Escuela de Padres - Desarrollo socioemocional y bienestar familiar",
        description: "La Dirección en coordinación con la APAFA del IES 'José Carlos Mariátegui' de Copani convoca a los padres de familia a participar en la Escuela de Padres, programada para el jueves 24 de julio de 2025 en la Sala de Usos Múltiples.",
        agenda: [
            "Habilidades socioemocionales y hábitos de estudio",
            "Prevención y atención de violencia sexual, física y psicológica",
            "Nutrición y alimentación saludable",
            "Salud mental y acompañamiento emocional en la familia"
        ],
        participants: ["Padres de familia", "Dirección", "Especialistas invitados", "APAFA"],
        location: "Sala de Usos Múltiples (SUM)",
        category: "Formativo",
        organizer: "Dirección del IES José Carlos Mariátegui y APAFA",
        required: false,
        minAttendance: 1,
        status: "scheduled",
        materials: ["Guía socioemocional", "Material de prevención", "Recetario saludable", "Lista de recursos psicológicos"],
        recording: false,
        followUpRequired: true
    },
    {
    ...
    },
    {
        ...
        agenda: [
            "Informe de presupuesto por mantenimiento del local",
            "Informe de recaudación de recursos propios",
            "Informe de recursos económicos de APAFA",
            "Renovación del Consejo Directivo de APAFA"
        ],
        participants: ["Padres de familia", "Dirección", "APAFA"],
        location: "Sala de Usos Múltiples (SUM)",
        category: "Padres de familia",
        ...
        minAttendance: 1,
        status: "scheduled",
        materials: ["Resumen de presupuesto", "Informe económico", "Padrón de APAFA", "Boleta de votación"],
        recording: false,
        followUpRequired: true
    },
